var mensData = [
  ...
  mensData.forEach(function(ele){
      ...
      imageone.setAttribute("src",ele.image_url);
      ...
      var productstrike=document.createElement("p");
      productstrike.innerText=ele.strikedoffprice;
      ...
      box.append(imageone,productname,productprice,productstrike,but);
